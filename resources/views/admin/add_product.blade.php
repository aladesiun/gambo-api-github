                            ...
                            <div class="card-body-table">
                                <div class="news-content-right pd-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="purchase_price" type="text" class="form-control" placeholder="$0" />
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">Bulk Price*</label>
                                        <input name="bulk_price" type="text" class="form-control" placeholder="$0" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="active" class="form-control" required>
                                            <option selected>Active/verified</option>
                                            <option value="1">Inactive/notVerified</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input name="" type="file" class="custom-file-input" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input name="" type="file" class="custom-file-input" id="inputGroupFile05" aria-describedby="inputGroupFileAddon05" />
