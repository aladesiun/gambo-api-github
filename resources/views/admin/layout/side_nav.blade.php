                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="/category">All Categories</a>
                            <a class="nav-link sub_nav_link" href="/category/add">Create Category</a>
                        </nav>
                    </div>
                    ...
                    <div class="collapse" id="collapseProducts" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="/product">All Products</a>
                            <!-- <a class="nav-link sub_nav_link" href="add_product">Add Product</a> -->
                            <a class="nav-link sub_nav_link" href="/product/add">Add Products</a>
...
{{--                        <nav class="sb-sidenav-menu-nested nav">--}}
{{--                            <a class="nav-link sub_nav_link" href="locations">All Locations</a>--}}
{{--                            <a class="nav-link sub_nav_link" href="add_location">Add Location</a>--}}
{{--                        </nav>--}}
{{--                    </div>--}}
...
{{--                        <nav class="sb-sidenav-menu-nested nav">--}}
{{--                            <a class="nav-link sub_nav_link" href="areas">All Areas</a>--}}
{{--                            <a class="nav-link sub_nav_link" href="add_area">Add Area</a>--}}
{{--                        </nav>--}}
{{--                    </div>--}}
