                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="posts">All Posts</a>
                    ...
                    <div class="collapse" id="collapseProducts" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="products">All Products</a>
                            <!-- <a class="nav-link sub_nav_link" href="add_product">Add Product</a> -->
                            <a class="nav-link sub_nav_link" href="/add">Add Products</a>
                    ...
                    <div class="collapse" id="collapseLocations" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="locations">All Transactions</a>
{{--                            <a class="nav-link sub_nav_link" href="add_location">Add Location</a>--}}
                    ...
                    <div class="collapse" id="collapseAreas" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link sub_nav_link" href="/auth/users">Users</a>
                            <a class="nav-link sub_nav_link" href="/auth/create">Create User</a>
                        </nav>
                    </div>
